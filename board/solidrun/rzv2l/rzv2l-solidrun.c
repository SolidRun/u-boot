...
static void carrier_select_fdt(int carrier)
{
	...
	case CARRIER_HB_PULSE:
		env_set("fdtfile", "renesas/rzv2l-hummingboard-ripple.dtb");
		break;
	case CARRIER_HB_PRO:
		env_set("fdtfile", "renesas/rzv2l-hummingboard-pro.dtb");
		break;
	case CARRIER_HB_IIOT:
		env_set("fdtfile", "renesas/rzv2l-hummingboard-iiot.dtb");
		break;
	default:
