...
struct dram_timing_info dram_timing_nxpevk = {
...
static struct dram_fsp_msg lpddr4_dram_fsp_msg_reduced[] = {
	{
		/* P1 100mts 1D */
		.drate = 100,
		.fw_type = FW_1D_IMAGE,
...
/* lpddr4 timing config params on EVK board reduced */
struct dram_timing_info dram_timing_nxpevk_reduced = {
	.ddrc_cfg = lpddr4_ddrc_cfg,
	.ddrc_cfg_num = ARRAY_SIZE(lpddr4_ddrc_cfg),
	.ddrphy_cfg = lpddr4_ddrphy_cfg,
	.ddrphy_cfg_num = ARRAY_SIZE(lpddr4_ddrphy_cfg),
	.fsp_msg = lpddr4_dram_fsp_msg_reduced,
	.fsp_msg_num = ARRAY_SIZE(lpddr4_dram_fsp_msg_reduced),
	.ddrphy_trained_csr = lpddr4_ddrphy_trained_csr,
	.ddrphy_trained_csr_num = ARRAY_SIZE(lpddr4_ddrphy_trained_csr),
	.ddrphy_pie = lpddr4_phy_pie,
	.ddrphy_pie_num = ARRAY_SIZE(lpddr4_phy_pie),
