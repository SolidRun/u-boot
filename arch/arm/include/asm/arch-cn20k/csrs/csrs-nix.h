...
#define NIX_LINK_E_RPMX_LMACX_CNF20KA(a, b) (0 + 4 * (a) + (b))
...
union nix_rq_ctx_hw_s {
	...
	struct nix_rq_ctx_hw_s_s {
		...
		u64 reserved_366                     : 1;
		u64 reserved_367                     : 1;
		u64 reserved_368_375                 : 8;
		u64 reserved_376_379                 : 4;
		u64 reserved_380_381                 : 2;
